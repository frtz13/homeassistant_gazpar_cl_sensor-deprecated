...
NB: actuellement, dans la v. 2022.11.4 de Home Assistant, les deux sensors "Gas consumption index..." n'apparaissent plus dans la liste de sélection des sources de consommation de  gaz du tableau de bord Energie. Espérons que ce dysfonctionnement sera corrigé rapidement. Cela n'affecte pas les installations, dans lesquelles un de ces sensors a été ajouté précédemment.
